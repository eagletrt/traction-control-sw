...
void Regen_step(RT_MODEL_Regen *const Regen_M) {
	 ...
	 */
	Fx_f = -Regen_pressure_f * 0.1 * 490.62500000000006 * 4.0 * 0.42 * 69.0 / 203.0;
	 ...
	 *  Product: '<S1>/Product2'
	 */
	Fx_f = fmax(fmax((((3198.788742857143 - sqrt(4.092899768571832E+7 - 4.1425668E+7 * Fx_f / 875.0) / 2.0) - Fx_f) *
												203.0 / 78.75 -
										-Regen_pressure_r * 0.1 * 490.62500000000006 * 2.0 * 0.42) *
											 78.75 * 0.001 * (2.0 * Regen_Inp_map_sc),
									 rtb_Switch2),
							tmp);
